...
function ReferenceCard(props: {
    ...
    const totalPallets: number =
        calc?.calculation?.totalPallets || calc?.calculation?.pallets?.length || 0
                    ...
                    >
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    Are you sure you want to delete reference "{calc.referenceId}"?
            ...
            <CardContent className="pt-0">
                ...
                <div className="flex justify-between items-center mb-2">
                    ...
                    <Badge variant="secondary">
                        {PALLET_TYPES[calc.palletConfig.type as keyof typeof PALLET_TYPES]?.name ||
                            calc.palletConfig.type}
                    </Badge>
                </div>
                ...
                {data ? (
                    <div className="grid grid-cols-2 gap-y-2 gap-x-4 text-sm mb-4">
                        ...
                        <div className="text-right font-medium">
                            {(calc.palletConfig.width || 0).toFixed(0)}" ×{" "}
                            {(calc.palletConfig.depth || 0).toFixed(0)}" ×{" "}
                            {Number(data.totalHeight || 0).toFixed(1)}"
                        </div>

                        <div className="text-gray-600">Weight:</div>
                        <div className="text-right font-medium">
                            {Number(data.totalWeight || 0).toFixed(0)} lbs
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredCalculations.map((calc) => (
                                    <ReferenceCard
                                        ...
                                        onCancelDelete={cancelDelete}   // ← new
